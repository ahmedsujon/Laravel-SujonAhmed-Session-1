...
<section class="wrapper">
    <div class="row mt">
        <div class="col-lg-12">
          ...
          <form role="form" action="{{route('category.store') }}" method="POST" class="form-horizontal style-form">
            @csrf
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  <input type="text" name="code" placeholder="" id="f-name" class="form-control">
                </div>
              </div>
              <div class="form-group">
